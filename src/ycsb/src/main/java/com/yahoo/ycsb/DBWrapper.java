...
public class DBWrapper extends DB {
    ...
    public int read(String table, String key, Set<String> fields, Map<String, ByteIterator> result) {
        ...
        int res = db.read(table, key, fields, result);
    ...
    public int scan(String table, String startKey, int limit, Set<String> fields, List<Map<String, ByteIterator>> result) {
        long st = System.nanoTime();
        int res = db.scan(table, startKey, limit, fields, result);
        long en = System.nanoTime();
    ...
    public int update(String table, String key, Map<String, ByteIterator> values) {
        long st = System.nanoTime();
        int res = db.update(table, key, values);
        long en = System.nanoTime();
    ...
    public int insert(String table, String key, Map<String, ByteIterator> values) {
        long st = System.nanoTime();
        int res = db.insert(table, key, values);
        long en = System.nanoTime();
    ...
    public int delete(String table, String key) {
        long st = System.nanoTime();
        int res = db.delete(table, key);
        long en = System.nanoTime();
        measurements.measure("DELETE", (int) ((en - st) / 1000));
