...
public abstract class DB {
     ...
     *
     * @param table  The name of the table.
     * @param startKey    The record startKey of the first record to read.
     ...
     */
    public abstract int scan(String table, String startKey, int limit, Set<String> fields, List<Map<String, ByteIterator>> result);
